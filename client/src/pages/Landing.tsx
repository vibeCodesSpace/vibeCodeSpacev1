        ...
        <div className="flex flex-wrap justify-center">
          <div className="w-full md:w-1/3 p-4">
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-2">Multi-AI Provider Support</h3>
        ...
        <div className="flex flex-wrap justify-center">
          <div className="w-full md:w-1/3 p-4">
            <div className="bg-gray-900 p-6 rounded-lg">
              <p className="mb-4">"VibeCode is a game-changer. I was able to create a portfolio site in minutes."</p>
              <p className="font-bold">- A Happy Developer</p>
            </div>
          </div>
          <div className="w-full md:w-1/3 p-4">
            <div className="bg-gray-900 p-6 rounded-lg">
              <p className="mb-4">"I don't know how to code, but with VibeCode, I was able to launch my business's landing page in an afternoon."</p>
