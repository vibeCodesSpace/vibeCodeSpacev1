...
const PromptInput = () => {
  ...
  const handleInitialSubmit = async (e) => {
    ...
    setFollowUpQuestions([
      {
        id: 1,
        text: "What color scheme would you like for the app? (e.g., light, dark, blue-themed)",
        answer: "",
      },
      {
        id: 2,
        text: "Do you need user authentication (sign-up/sign-in)?",
        answer: "",
      },
      {
        id: 3,
        text: "What is the primary goal of the application?",
        answer: "",
      },
    ]);
    // --- End Mock API Call ---
  ...
  const handleFinalSubmit = async () => {
    ...
    const finalContext = {
      ...
      clarifications: followUpQuestions.map(({ text, answer }) => ({
        question: text,
        answer,
      })),
    };
